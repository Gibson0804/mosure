import{r as _,R as e}from"./vendor-react-5293c662.js";import{S as Ie}from"./vendor-inertia-4fcef779.js";import{generateMediaApiDemos as $e,generateFunctionApiDemos as Ee,generateApiDemos as xe,generateSubjectApiDemos as ke,demoMediaOperations as Oe,demoOperations as Ae,demoSubjectOperations as Ce}from"./ApiDemo-0a90ac9f.js";import{u as ze}from"./useTranslate-69570f29.js";import{a as Ne}from"./Service-62f4b6a8.js";import{ad as Z,h as He,_ as Q,S as L,a5 as T,ae as ge,K as ye,N as H,af as re,Y as R,a7 as _e,ag as Ge,a4 as Me,T as j,a6 as P,a2 as qe,m as F}from"./vendor-antd-e89c0c7d.js";import"./vendor-amis-97daef07.js";import"./vendor-misc-43191129.js";import"./vendor-markdown-70ffc934.js";import"./vendor-katex-98160839.js";import"./vendor-dayjs-8586a5b4.js";const u=a=>(a||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),O=(a,n,l)=>{let i=`<h3>${u(a)}示例</h3>`;return l.forEach(r=>{const c=r==="curl"?"cURL":r==="javascript"?"JavaScript":r==="php"?"PHP":"Python",p=n[r]||"";p&&(i+=`
        <h4>${c}</h4>
        <pre>${u(p)}</pre>
